      ...
      <Container>
        ...
        <article className="w-75 m-auto pt-2 text-justify">
          ...
          <p className="i-5 mt-4 pt-2">
            ...
            (IaC). My primary tool of choice is&nbsp;
            <a
            ...
            &nbsp;
            as well. Additionally, I help guide my customers on their 
            journey from the on-prem world into the cloud by designing and 
            validating modern and cost-effective cloud solutions.
          </p>
          <p className="i-5">
            In my spare time, I am a Freemason, track-day enthusiast and driver of fast cars on
            track, husband and father.
          </p>
          <p className="i-5">
